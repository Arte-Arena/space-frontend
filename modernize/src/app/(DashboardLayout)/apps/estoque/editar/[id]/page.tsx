...
import { Estoque, EstoqueData, Fornecedor } from '../../components/Types';
...
const AdicionarProdutoEstoqueScreen: React.FC = () => {
  ...
  const [data, setData] = React.useState<EstoqueData>();
  ...
  const { id } = params;
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API}/api/estoque/${id}`, {
      method: "GET",
      headers: {
